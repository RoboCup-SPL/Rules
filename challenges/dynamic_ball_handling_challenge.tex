...
\begin{description}
	\item[Attacker:] 1st: goal area front line (Player No 1); 2nd: near to center line left of center circle, but at least \qty{10}{\cm} in its own half (Player No 2); 3rd: next to center line right of center circle, but at least \qty{10}{\cm} in its own half (Player No 3).
	\item[Defender:] 1st: within center circle, but at least \qty{10}{\cm} in its own half(Player No 3); 2nd: front line penalty area (Player No 2); 3rd: goalkeeper in the middle between the two goal posts (Player No 1).
