...
The ready signal must be triggered manually using a sequence of sensors or buttons, at the team’s discretion, when instructed by the referee.
This manual input may also be used to indicate the position of the ramp to the robot.
The ball will be released from the ramp approximately \qty{5}{\second} after the manual signal is triggered.
During this time, there is no limitation to robot movement or locomotion.
...
\begin{itemize}
  ...
  If the ball touches both feet, only the first contact will be evaluated.
  While teams are expected to produce a controlled kick, this challenge does not distinguish between a kicking and a walking motion.
  \subsection{Ranking}
