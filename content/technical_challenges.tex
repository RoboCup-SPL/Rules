    ...
    \subsubsection{Challenge setup}
        ...
        \begin{enumerate}
            ...
            \begin{enumerate}
                ...
                \item The robots output should be repeated as long as, its front head button gets pressed for at least \qty{1}{\second} to indicate that the next signal will come. This should give the referee time to understand the robot's audio output clearly.
            \end{enumerate}
