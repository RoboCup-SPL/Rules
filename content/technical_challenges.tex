...
\subsection{7 vs. 7}
    ...
    \subsubsection{Rules}
        ...
        \paragraph{Robot pool disqualification}
            All teams using robots for the robot pool are encouraged to implement robot protection features to prevent abnormal number of damages and probability of a fallen robot. The teams providing robots trust in the teams using their robots that they operate them with care.
