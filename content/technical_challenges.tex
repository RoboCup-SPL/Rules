...
\subsection{Visual Referee Challenge}
    ...
    \subsubsection{Challenge Goal}
        ...
        The intent of this challenge is to choose a \emph{subset} of potential referee calls in SPL games and test ability of a robot to recognise different types of hand signals in preparation for adoption in RoboCup games, rather than compile a complete set of all possible referee signals.
    ...
    \subsubsection{Challenge setup}
        ...
        The description of the challenge (and referee signals) is described based on the viewpoint of the head referee. In these descriptions the ``red team'' is defines as playing from left-to-right, and the ``blue team'' as playing from right-to-left. The use of colours for identifying teams is used to give equivalence to the head referee calls during SPL games.
        ...
        \begin{enumerate}
            ...
            \item The referee selects and indicated a hand-signal. The referee must indicate this signal for \qty{10}{\second}. \todo{reduced this time as 15s is unnecessarily long.}
            \item During that time or in the additional \qty{10}{\second}, the robot must indicate the hand-signal that it has identified by:
            \begin{enumerate}
            ...
            \item If the robot cannot idetnfity the signal, it should remain motionless and provide no audio output. A robot may continue to pose in the same position as the last signal it identified.
    ...
    \subsubsection{Available Hand-Signals}
        ...
        Each hand-signal for the challenge is described and pictured, and the robot-equivalent gesture. Note that for the purpose of clarity, these do not necessarily correspond to human soccer hand-signals.

        \begin{itemize}
            \item \textbf{Goal \textlangle{}colour\textrangle{} Team.}
            One-handed signal. One arm, extended horizontally in the \emph{playing} direction of the team that scored the goal. That is, right arm extended for the ``Red team'', and left arm extended for the ``Blue team''.
%            \begin{figure}[ht!]
...
%            \end{figure}
            ...
            One-handed signal. One arm, extended 45-degree \emph{up} in the direction of the team that has been given the goal kick. That is, right arm extended for the ``Blue team'', and left arm extended for the ``Red team''.
            \begin{figure}[ht!]
                \centering
                \begin{subfigure}{.33\textwidth}
                  \includegraphics{figs/kick-off_referee.jpg}
            ...
            One-handed signal. One arm, extended 45-degree \emph{down} in the direction of the team that has been given the corner kick. That is, right arm extended for the ``Blue team'', and left arm extended for the ``Red team''.
            \begin{figure}[ht!]
                \centering
                \begin{subfigure}{.33\textwidth}
                  \includegraphics{figs/kick-off_referee.jpg}
            ...
            \item \textbf{Kick-Off \textlangle{}colour\textrangle{}  Team.}
            Two-handed signal. One arm, extended pointing at the center circle. One arm, extended horizontally in the \emph{playing} direction of the team that has the kick-off. That is, right arm extended for the ``Red team'', and left arm extended for the ``Blue team''.
            \begin{figure}[ht!]
                \centering
                \begin{subfigure}{.33\textwidth}
                  \includegraphics{figs/kick-off_referee.jpg}
            ...
            Two-handed signal. One arm, vertical with bent below and palm facing in the direction of the extended arm. One arm, extended horizontally in the \emph{playing} direction of the team that has been \emph{given} the penalty. That is, right arm extended for the ``Red team'', and left arm extended for the ``Blue team''.
            \begin{figure}[ht!]
                \centering
                \begin{subfigure}{.33\textwidth}
                  \includegraphics{figs/kick-off_referee.jpg}
    ...
    \subsubsection{Challenge evaluation}
        ...
        Teams are ranked by their total points. In the even of tie-breaks, the team with the fastest total time to identify all hand-signals is ranked higher. The team with the highest total points, and lowest total time (for tie-breaks), wins the challenge. 
