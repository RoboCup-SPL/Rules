...
\subsection{Dynamic Ball handling Challenge}
    ...
    \begin{figure}[t!]
          	\begin{center}
          		...
          		\caption{Positions of the attacking (red) and defending (blue) robots at the beginning of the challenge. The black semicircle indicates the area in which a pass is valid.}
