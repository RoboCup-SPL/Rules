...
\subsection{Dynamic Ball handling Challenge}
    ...
    \subsubsection{Challenge Execution}
        ...
        Fall and inactive robots get the standard removal penalties. In this case the remaining robots have to take over the task of the penalized robot. They have to operate in the intention of the challenge to perform two passes.
