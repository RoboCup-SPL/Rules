...
\cbp{To avoid the need for hosting teams to construct new fields for the GORE 3.0 in 2022, fields with outer field line dimensions of at least 6m x 4m can be used. Goal dimensions should still be the same as the standard size field.}
...
\cbp{Nevertheless, it is not expected that teams should change the lighting setup in their local venue for the purpose of GORE 3.0 in 2022.} \\
