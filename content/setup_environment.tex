...
\cbp{To avoid the need for hosting teams to construct new fields for the GORE 2022, fields with outer field line dimensions of at least 6m x 4m can be used. Goal dimensions should still be the same as the standard size field.}
