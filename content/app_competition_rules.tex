...
There are 24 qualified teams. 12 teams are placed in the Champions Cup. 12 teams are placed in the Challenge Shield. Teams retain their placing in the Champions Cup or Challenge Shield between each year, unless otherwise promoted or relegated as described below. \todo{TW: This is a big change, teams are fixed to each 'division' and must essentially qualify to be in the Champions Cup}
...
Each division will have a round-robin stage, and a knockout competition. The round-robin stage consists of 2 groups of 6 teams.\todo{Without the intermediate rounds/2nd round, there is more time for round-robin games}. Glicko rankings shall be used to seed teams into the round-robin groups. The top four teams of each groups at the conclusion of the round-robin proceed to the the knockout competition. \todo{This could be also be a 12-team knockout} The knockout-competition will therefore feature 8 teams, consisting of quarter-finals, semi-finals, 3rd place match, and the final.
...
\todo{TW: I expect this to be contentious. The intent here is to give robots more time and structure. That is, a less "quick" resumption.}
...
\todo{TW: This is intended to ensure challenge shield teams have a proper restart from a Free Kick}
...
\todo{TW: Remove this is not using the CS free kick procedure above}
...
\todo{TW: This is possible. The goal is to have the CS robots on the field more, but i've no strong opinion to keep at 45s.}
...
\todo{TW: This is key part. CS teams suffer too much from increasing penalties.}
