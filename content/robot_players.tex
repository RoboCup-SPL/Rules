...
\cbp{Hosting teams/arenas must designate a ``home'' color and an ``away'' color when applying for GORE 3.0 in 2022. The team leaders can discuss the jersey assignment before the game. If no consensus is reached then the following applies:} 
