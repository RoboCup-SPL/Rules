...
%Each team must designate a ``home'' color and an ``away'' color when asked about one month before RoboCup. 
\cbp{Hosting teams/arenas must designate a ``home'' color and an ``away'' color when applying for GORE 2.0 in 2022. The team leaders can discuss the jersey assignment before the game. If no consensus is reached then the following applies:} 
