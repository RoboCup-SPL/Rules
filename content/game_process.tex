...
\begin{enumerate}
  ...
  \item For a \textit{Penalty Kick}:  ``Penalty Kick \textless team\textgreater'' for the fouled team, followed by ``Foul \textless color\textgreater \textless number\textgreater'' to penalize the pushing robot.
\end{enumerate}
