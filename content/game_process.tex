...
Both teams are also subject to restrictions on the penalty area~(\cf Section~\ref{sec:illegal_positioning}).
...
\begin{itemize}
  ...
  \item A pushing penalty (see Section~\ref{sec:player_pushing}) awarded near the ball against the defending team within their own penalty area, termed a \textit{Penalty Kick}.
\end{itemize}
...
\begin{enumerate}
    ...
    \item No other robots may enter the penalty area (\cf Section~\ref{sec:illegal_positioning}).
