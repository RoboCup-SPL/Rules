...
\begin{description}
  ...
  \item[Example 5:] Players of the red team misses it to proceed of Kick off. After the ball is free the defending team kicks the ball direct into the goal. This is \textit{not} an indirect kick, and the goal does not count.
\end{description}
