...
If a robot violates the positioning restrictions made in \cref{sec:kick-off} at the time the Set state starts, it will be penalized and removed for \qty{15}{\second}.
If a robot enters the areas of the other team before the ball in \textit{play}, it will be penalized and removed according to the standard removal penalty.
