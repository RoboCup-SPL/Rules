...
Both teams send a representative called team captain to the field \qty{10}{\minute} before their match starts. This time should be used for welcome each other, discuss match related topics and decide who plays on which side, who has Kick-Off and agree on jersey colors. A coin throw by the head referee selects with tail up the first team in the schedule to choose if they want to choose for side or Kick-Off and head up asks the second team to choose first.

During a match only the team captains are communicating with the head referee. Only the team captains and two more people per teams are allowed to stay next to the game controller tables. The rest of the team keeps distance. This allows the referees easier communication with the team and the game controller operator gets less disturbed.

After a match the teams thank the referees for their duty. 

During all phases of a match teams and referees are communicating with respect to each other. 
