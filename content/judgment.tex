...
Both teams send a representative called team captain to the field \qty{5}{\minute} before their match starts. This time should be used for welcome each other, discuss match related topics.
