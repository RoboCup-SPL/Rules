...
Every team participating in a challenge, must publish the corresponding code used in that competition according to \todo{Section in rules book}. Except a specific challenge states it differently. 
...
\include{challenges/visual_referee_challenge}

\include{challenges/dynamic_ball_handling_challenge}

\include{challenges/data_minimization_challenge}
