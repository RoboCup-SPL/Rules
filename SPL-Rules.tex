...
\begin{itemize}
\item Any player may be goalie (ie, enter the goal box and behave as goalie).  However, once one player has become goalie for a team, this player will be the goalie for the remainder of the game.  Any subsequent defensive players to enter the goal box will be removed as illegal defenders. \todo{Check this after overworking the illegal defender rule}
\end{itemize}
...
\begin{itemize}
	...
	\item Removed the 'Playing with Hands' requirement for the action to be intentional and manupulative.  Any robot who contacts the ball with hand or arms (and is not the goalie in the penalty box) will be penalized. (Section \ref{sec:hand_ball})
