...
The field players of the defending team can walk to any position within their own half, except for inside the center circle.  Only one field player of the defending team may be within the penalty area during the set state.  If multiple field players of the defending team are within the penalty area during the set state, the robot closer to center field should be placed manually by the assistant referees to the closest position as shown in Figure~\ref{fig:ko}.
