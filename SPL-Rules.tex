...
\item Fixing the location of the upper camera using a bit of glue. \todo{Tim: We need to check, if this kind of rule is OK for Aldebaran. Katie: Working on this.}
