...
\item If the ball was touched by the offensive team, a Goal Free Kick is awarded to the defensive team, and the ball is
...
\begin{itemize}
  ...
  \item A pushing penalty awarded near the ball, termed a \emph{Penalty Free Kick}, see Section~\ref{sec:player_pushing}.
\end{itemize}
...
\begin{enumerate}
  ...
  \item Game Controller will change the Game state to \emph{Free Kick}.
  \item For a Goal Free Kick, the ball will be positioned by the assistant referee, on the Goal Kick Spot.
  ...
  \begin{enumerate}
    ...
    \item Opposition robots that violate these conditions are penalised with the ''Illegal Defender'' penalty (see Section~\ref{sec:illegal_defender}) which results in a standard removal penalty (see Section~\ref{sec:removal_penalty}).
...
The striker robot is only allowed to contact the ball once.  The time limit for the striker is 30 seconds after the penalty kick starts. The ball must be in the goal within this time limit in order to count as a goal.
