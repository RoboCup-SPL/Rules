...
\begin{enumerate}
	...
	\item A robot currently getting up cannot be penalized for pushing, nor can a player be penalized for walking into a fallen robot.
...
\begin{enumerate}
	\item Any form of contact that has enough force to destabilize a robot, such that walking and/or kicking is impeded.
...
\begin{itemize}
	...
	\item A robot currently getting up cannot be penalized for pushing, nor can a player be penalized for walking into a fallen robot. (Section \ref{sec:situations_no_pushing})
