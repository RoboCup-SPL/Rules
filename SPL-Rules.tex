...
The two metrics will be normalized when determining the overall winner of this competition --- which will receive the ``Best Player'' award.  Additionally, the top five drop-in players from the competition (the SPL All Stars) will play together against the 1st place team in the team competition after the championship game.  The normalization factor will be computed to be \[\frac{10}{\text{best average goal difference of a drop-in player}}\]
