...
A Robot that has ceased activity for 10seconds will be removed by the referees and subject to the standard penalty. A robot is active if it performs at least one of the following:
\begin{enumerate}
