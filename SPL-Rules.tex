...
\begin{enumerate}
\item if both robots are stationary, neither is penalized;
\item if 1 of the robots is a goal keeper in its penalty area, the other one is penalized;
\item if 1 of the robots is stationary, the other one is penalized;
...
The following forms of contact are considered pushing:
