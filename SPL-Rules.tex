...
The judges will be members of the technical committee.  There will be atleast two judges for each game, where judges will not judge any game in which their team is competing.  The judges will score the players based on the following criteria:
\begin{itemize}
