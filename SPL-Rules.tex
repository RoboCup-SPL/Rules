...
It is discouraged to change the robot's control program, but not forbidden.
...
To prevent mistakes and confusion during games, only team leaders should make a ``Request for Pick-up'', accept the robot from the referee, and hand it back after fixing the problem.
