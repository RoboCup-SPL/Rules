...
\begin{itemize}
	...
	\item  A robot pushed by another robot can not simultaneously be called for pushing itself. (Section \ref{situations_no_pushing})
...
\begin{itemize}
	\item There will be a skill test held for drop-in player competition players.  The results of the skill test will be used to seed players. (Section \ref{sec:sec:drop-in})
