...
\begin{enumerate}
\item If one robot is a goal keeper in its penalty area and the other is moving, the other latter one is penalized;
\item If only one robot is stationary out of two field players, the other one is penalized;
\item If both robots are moving, the robot closer to the ball is penalized.
\end{enumerate}
...
The standard removal penalty will apply for pushing. \emph{The 4th time a team is called for pushing in a half, the offending robot will be removed for the remainder of the half. Subsequently for the half, a robot from the team will be removed for every 2 pushing offenses (i.e., the 6th, and 8th times).}
