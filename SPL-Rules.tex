...
\begin{center}
\leavevmode
\includegraphics[width=0.8\columnwidth]{figs/goals2010.png}\\
%\vspace{10pt}
...
The official ball will be an orange street hockey ball. They are 65 mm in diameter and weigh 55 grams. These balls are available at a few locations:
\begin{itemize}
...
Robots will have easily changeable uniforms that are still to be determined.
...
\item If the ball was touched by the offensive team, the the ball is replaced at on the throw-in line at the farthest back of these three locations: a) one meter back from the point it went out, b) one meter back from the location of the kicking robot, or c) at the halfway line.
...
There are also a few changes still under discussion.

\begin{itemize}
\item We will institute stricter pushing rules (Sec.~\ref{sec:player_pushing}).
\item We will have new uniforms (Sec.~\ref{sec:team_markers}).
\end{itemize}
