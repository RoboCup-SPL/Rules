...
\begin{itemize}
	...
	\item Each of the top two teams from each outdoor pool will be randomly distributed into the four second round indoor pools.  However, the random distribution must be repeated until:
	\begin{itemize}
		\item No second round pool contains more than one team that finished in the top 4 at the 2015 Main Competition
		\item No second round pool contains more than one team that was eliminated in the quarterfinals at the 2015 Main Competition
	\end{itemize}
	\item Each of the remaining four outdoor teams will be randomly distributed into the four second round indoor pools.  However, the random distribution must be repeated until:
	\begin{itemize}
		\item No second round pool contains more than one team that finished in the top 4 at the 2015 Main Competition
		\item No second round pool contains more than one team that was eliminated in the quarterfinals at the 2015 Main Competition
	\end{itemize}
...
\begin{itemize}
	...
	\item Both teams will wear their `home' jerseys unless this would cause the two teams to have too similar jerseys.  In this case, the `away' team will wear its `away' jerseys. (Section \ref{sec:team_markers})
