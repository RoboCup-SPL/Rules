...
\begin{itemize}
	...
	\item A goal can never be awarded where the last contact of the ball with a robot was by the arm or hand (unless the goal was by a defending goalie in its penalty box). All such instances will be regarded as `Playing with Arms/Hands' (see Section \ref{sec:hand_ball}).  (Section \ref{sec:goal}).
