...
\begin{center}
This is a preliminary rulebook.  We plan to further update the rulebook for the 2016 drop-in player competition as well as any changes required after 2016 Open competitions.
...
Either team may request that one of their players be picked up (called ``Request for Pick-up'').  Players in the Playing state may only be picked up for for hardware failures.  Players in all other states may be picked up for any reason.
