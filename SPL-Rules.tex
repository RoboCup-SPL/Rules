...
\todo{Team markers are still being finalized.}Robots will use colored waistbands as team markers. Official waistbands are blue and pink and have been distributed to each team. An example of how the team markers are worn is shown in Figure~\ref{fig:nao_markers}.
...
\begin{itemize}
	...
	\item Increased the number of players to \textbf{5} (\cf Section~\ref{sec:robot_players}).  Legal kick off positions, as well as manual positions, were updated (cf. Section~\ref{sec:kick-off}).
