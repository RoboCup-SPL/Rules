...
If two or more robots from a team are at the ball, this is allowable until a robot from the opposing team approaches the cluster of robots.  The first robot contacted by the approaching robot is removed according to the standard removal penalty.  If two or more robots from one team remain at the ball, these robots should also be removed until only one robot from each team remains at the ball.
