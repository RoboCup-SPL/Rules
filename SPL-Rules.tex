...
Accidental playing with arms/hands when a robot falls or executes a get-up routine will not be penalized. If the ball goes out of play, normal throw in rules will apply (Section \ref {sec:throw_in}).
...
\begin{itemize}
	\item Added exceptions to playing the ball with arms/hands. (Section \ref {sec:hand_ball})
\end{itemize}
