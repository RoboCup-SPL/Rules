...
Each participating team is required to email a short (no more than 200 words) explanation of their drop-in player strategy to \url{rc-spl-tc@lists.robocup.org} by the end of the final competition day at RoboCup 2015.  These descriptions will be released on the SPL wiki soon after the competition.
...
\item No player may be ejected due to penalties.
