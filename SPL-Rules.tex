...
Before the initial kick-off, i.e. before the start of each half, all robots must be in the initial state and must be placed on one of the sidelines in their own half of the field.
...
The intend of switching to same-colored goals is to remove artificial landmarks.
