...
Teams may attach, print, or sew sponsor or team logos to the back side of the official jersey shirts.  One acceptable location is centered above the number on the back of the jersey, while the other acceptable location is centered below the number on the back of the jersey.  Teams may only place a logo in one of these two locations.

Logos in one of two styles are allowed.  The first style would be a white background with black text.  The second style would be one in which a white or black logo is screen-printed on the jersey, such that the background of the logo is the jersey.  In either case, the dimensions of the area of the jersey that is non-jersey color may be no larger than 8mm in width and 2.5mm in height.
...
\emph{Pushing} is a forceful contact with another robot, \ie, enough to destabilize it, and is not allowed. In the following, the cases when pushing occurs as well as exceptions are specified in more detail.
