...
The soccer field is built on a total carpet area of length \TotalLength and width \TotalWidth.  The carpet should have a flat wooden base underneith.  Care should be taken to ensure the field is as flat and level as possible.
