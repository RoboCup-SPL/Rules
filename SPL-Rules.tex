...
\begin{itemize}
	\item Referees and the GameController should study for, take, and pass an online rules test before attending RoboCup.
	\item Teams will no longer evaluate referees and GameControllers.
\end{itemize}
