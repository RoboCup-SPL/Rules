...
\item Goals~(\cf Figure~\ref{fig:goal_colors}). The posts and top cross bar of both goals are yellow. The support triangles on back of the posts and the net are white (yellow: RAL 1018).
...
\caption{Appearance of the goals. Notice that the support triangles are white.}
