...
Each drop-in player must communicate with its teammates using SPL standard message protocol (\cf Section \ref{sec:wireless}).  Drop-in teams will use UDP ports 10098 and 10099.  Drop-in players who do not properly fill in and update each field in the standard message, as well as send at least X messages every minute, will not be allowed to play. \todo{what should X be?}
