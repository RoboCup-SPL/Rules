...
The following forms of contact are considered pushing contacts, except the scenarios listed in Section~\ref{sec:situations_no_pushing}:
\begin{enumerate}
...
If 3 robots are in contact or close to contact, and pushing occurs following the rules of Section 4.9.1, the team with more robots involved is the main offender and one of their robots will be penalized.
...
General situation where pushing does not apply:
...
Situations in which two upright robots of different teams are fighting for the ball:
...
\begin{itemize}
	...
	\item Removed an old rule: referees will not put upright a robot fallen after pushing, i.e., a robot hat to get up on its own (cf. Section~\ref{sec:pushing_results}).
\end{itemize}
