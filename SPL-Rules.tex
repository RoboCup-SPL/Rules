...
Each participating team is required to email a short (no more than 200 words) explanation of their drop-in player strategy to \url{rc-spl-tc@lists.robocup.org} by the end of the final competition day at RoboCup 2016.  Failing to do so when be considered in your 2017 application. These descriptions will be released on the SPL wiki soon after the competition.
...
\begin{itemize}
	\item The Standard Removal Penalty time is now incremental per team. (Section \ref{sec:removal_penalty})
