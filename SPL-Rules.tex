...
\begin{itemize}
	\item The head referee should not whistle to announce goals or penalities.  Both should be indicated verbally, and goals should be indicated by the head referee pointing with one arm towards the center of the field. (Section \ref{sec:head_referee})
	\item Updated the rules to reflect the fact that the assistant referees should handle judgements made by the head referee with regards to both robots and the ball. (Section \ref{sec:assist_referee})
\end{itemize}
