...
\item If the ball was touched by the offensive team, a \emph{Goal Free Kick} (\cf Section~\ref{sec:free_kick}) is awarded to the defensive team, and the ball is
...
\begin{enumerate}
  ...
  \item Game Controller will activate the substate for the respective free kick. Note that in the case of the Pushing Free Kick the substate is activated automatically through the ``Foul''.
