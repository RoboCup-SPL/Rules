...
The soccer field is built on a total carpet area of length \TotalLength and width \TotalWidth.  The carpet should have a flat wooden base underneith.  Care should be taken to ensure the field is as flat and level as possible.  Additionally, the wooden base should be well supported and hence not give when humans stand or walk on it.
...
\label{sec:acoustic}
There are no restrictions on communication between robots using built-in microphones, speakers, and infrared.  
...
No team or robot should listen into another team's communication.
