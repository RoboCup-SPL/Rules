...
\begin{itemize}
   \item Added the coaching robot. (Sections \ref{sec:robot_players} and \ref{sec:coaching_robot})
...
\begin{itemize}
	...
	\item The operator of the Game Controller is now officially in charge of game timing.  The operator should count aloud the remaining seconds in a half once the time remaining is 5 seconds or less. (Section \ref{sec:gameControllerOp})
\end{itemize}
