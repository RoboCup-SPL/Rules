...
\label{sec:setup_two_hours}
    ...
    \begin{enumerate}
        ...
        \item Dress robots with jerseys (see \ref{sec:team_markers}). By default: The hosting team's 'home' and 'away' jersey are assigned to the 'home' and 'away' starting robots, respectively. If a team wants to use its own jearseys they have to send the home jerseys to their primary arena and they can also send their away jerseys to the other arena.
    \end{enumerate}
