...
\begin{itemize}
    ...
    \item Wifi with standard SPL\textunderscore A SSID, standard password (as communicated during the competition via e-mail) and standard IP \texttt{10.0.0.2} address and DHCP turned off.
