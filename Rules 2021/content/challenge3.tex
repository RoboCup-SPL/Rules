...
By providing an autonomous setup, all teams are enabled to host training matches this in their local arena. Even teams not able to compete in RoboCup SPL 2021 benifit from this use case.
