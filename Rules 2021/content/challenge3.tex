...
\begin{itemize}
    ...
    \begin{itemize}
        \item \label{sec:robot_table} The hosting arenas prepare a table with the following columns: [Robot ID (1-16), Team, Head ID, Body ID, MAC address, IP address] 
...
\subsubsection{Game Setup}
	...
	\begin{enumerate}
		...
		\item volunteers -> Asistance -> Communication with their team during game over vouice Discord and communication with Head ref
