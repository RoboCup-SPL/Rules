...
\begin{itemize}
	...
	\item Wifi with standard SPL\textunderscore A SSID, standard password (as communicated during the competition via e-mail) and standard IP \texttt{10.0.0.2} address and DHCP turned off. \textcolor{red}{TODO: removed? \texttt{Nao?!Nao?!}}
...
\subsubsection{Start: 2h before match}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textcolor{red}{TODO:} do we allow installation of team code via network cable as alternative to USB-Drive + image?
        \end{itemize}
...
Game setup
    ...
    standardized procedure for all teams (Because volunteers move robots)
