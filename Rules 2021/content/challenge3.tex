...
\begin{itemize}
	...
	\item Expample File structure NextCloud
	\item Flashing
	\item Storage USB
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \label{sec:robot_table} The hosting arenas prepare a table with the following columns: [Robot ID (1-16), Team, Head ID, Body ID, MAC address of LAN, IP address] 
