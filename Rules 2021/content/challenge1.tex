...
\info[]{TODO: if ball is invalid in goal why not apply same rule as if ball goes out, because it is quite hard to get it out again and this procedure does not protect robots}
