...
\info[]{TODO: please consider specifying the tape colour to be green and that no white lines should be broken by the green tape}

\info[]{TODO: please consider specifying how robots should know if they are inside the allowed/red area. Should they self-localize using white field lines?}
...
\begin{itemize}
    ...
    \info[]{TODO: A robot is not allowed to enter the blue area. (Otherwise it could dribble the ball into the other area. Ball is moved and in the end touched by another robot.)}
\end{itemize}
