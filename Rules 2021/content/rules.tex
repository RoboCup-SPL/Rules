...
\cbp{If any robot player scores a goal (including own goals) the ball gets replaced by the referees to one of the ball starting points. The ball gets placed on the half opposite to the player that scored the goal. The ball is placed farthest away from the player that scored the goal. The ball can be played again without delay.}
