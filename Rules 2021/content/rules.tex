...
These rules are mostly taken from the 2020 rule book, but a few things have been added, modified and/or omitted due to the unique circumstances of 2021. Changes in individual chapters are marked with a \cbw{colourbox}.
...
\cbp{If a player (from both sides) scores a valid goal the ball gets replaced by the referees to one of the starting points, on the other half. The ball is placed farthest away from the player in this half and can then directly be played again.}
