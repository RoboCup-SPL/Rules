...
\cbp{If any robot player scores a goal (including own goals) the ball gets replaced by the referees to one of the ball starting points. The ball gets placed on the half opposite to the player that scored the goal. The ball is placed in the ball starting point farthest away from the player that scored the goal (unless blocked by a robot or ball then, the other goalbox corner is used). The ball can be played again without delay.}
