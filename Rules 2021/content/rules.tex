...
\cbp{Some of the challenges use stationary obstacle robots. \\
	...
	When a stationary obstacle robot is required to wear a jersey, any jersey that was approved for a RoboCup SPL competition in the last 4 years can be used otherwise \cf Section~\ref{sec:team_markers}}
