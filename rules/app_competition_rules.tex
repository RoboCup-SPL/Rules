...
In the competition stages before the quarter finals, the game clock counts down during the \texttt{ready} and \texttt{set} states except for the first kick-off in each half (\cf~\cref{sec:game_states}).
From the quarter finals onward, the clock stops during all stoppages of play.
...
Note, however, that the head referee and the GameController operator should always be from the same team.
...
Referees and GameController operators should be selected among the more senior members of a team, and preferably have prior experience with games in the RoboCup Standard Platform league.
