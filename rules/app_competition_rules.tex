...
\begin{itemize}
  ...
  \item Goals may be scored via direct kick from kick-off. The indirect kick rules remain unchanged for the Challenge Shield (\cf~\cref{sec:indirect_kick_old}), but were tightened for the Champions Cup.
\end{itemize}
