...
\begin{itemize}
  \item The requirement to recognize visual referee signals is relaxed for the Champions Shield (\cf~\cref{sec:robot_players}).

  % uncomment this after the relevant pull request is merged and update cref
  % \item Goals may be scored via direct kick from kick-off. The indirect kick rules are relaxed for the Champions Shield (\cf~\cref{sec:TODO}).
\end{itemize}
