...
Both teams send a representative called team captain to the field \qty{10}{\minute} before their match starts. This time should be used for welcome each other, choose for side and kick-off (see\,\ref*{sec:field_side_and_initial_kickoff}) and discuss match related topics.
