...
They should announce when the ball is in play on kick-off by stating ``Ball Free'', if the \qty{\KickOffBallFreeTime}{\second} time period has elapsed in the \texttt{playing} state.
