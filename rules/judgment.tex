...
Both teams send a representative called team captain to the field \qty{10}{\minute} before their match starts. This time should be used to welcome each other, choose side and kick-off (see~\cref{sec:field_side_and_initial_kickoff}) and discuss match related topics.
