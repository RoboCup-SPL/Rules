...
\begin{itemize}
  ...
  \end{itemize}
  \item The maximum number of data bytes in the \texttt{SPLStandardMessage} has been reduced from 474 to 128 (\cf~\cref{sec:wireless}, this change manifests itself only in the linked header file).
  ...
  \item The goalkeeper may play the ball with its arms/hands and deliberately fall within its own penalty area, not only the goal area (\cf~\cref{sec:fallenrobots,sec:hand_ball}).
