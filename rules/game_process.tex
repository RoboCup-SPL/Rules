...
The attacking team may only score a goal via indirect kick from \texttt{Kick-off}, \texttt{Kick-in} and \texttt{Free Kick}.
...
\begin{itemize}
  ...
  \item if an indirect free kick is kicked directly into the opponent's goal, a goal kick is awarded.
...
\begin{description}
  ...
  \item[Example 2:] Player 2 (of the red team) kicks the ball at the goal, and it is deflected of the side of the foot of a blue-team's robot into the goal.
    This is \textit{not} an indirect kick, the goal does not count and a goal kick is awarded to blue team.
  ...
  \item[Example 4:] Player 2 (of the red team), walks up to and dribbles the ball.
    ...
    The robot then scores. This is not a successful indirect kick and a goal kick is awarded.
\end{description}
