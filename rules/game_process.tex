...
When reaching the \texttt{set} state, the kick-off team can be positioned anywhere within their own half and the center circle.
...
\end{itemize}
The head referee will announce a free kick is completed, by ``Ball Free'', and the GameController resumes the game state \texttt{playing}. Note that the sub-state will be automatically left after the \qty{\FreeKickTime}{\second} time period expires.
