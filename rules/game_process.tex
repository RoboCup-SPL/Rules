...
If multiple robots from the attacking team are in the penalty area, the one robot not to be penalized will be the one that is closest to the penalty mark without blocking it.
