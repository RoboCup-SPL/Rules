...
In the event that there has been a referee error or a pause in game, and if a goal has not been scored by either team, the drop-ball rule shall apply. The head referee shall note the last location of the ball beforehand and will place it at that location before playing resumes. The only main example currently where the drop-ball rule would be required is when a referee timeout has been called with no goal being scored.
