...
\begin{itemize}
    \item The attacking team moves the ball clearly (except for a penalty kick: here is touching the ball sufficient to end the free kick), except for a robot getting up which is exempt from this rule.
