...
A game consists of four parts, pre-game meeting (see~\cref{sec:referee_team_communiation}), the first half, a half-time break, and the second half. Each half is \qty{10}{\minute} counted from the initial kick-off.
