...
\unsure[inline]{This gesture is entirely tentative and just my (Francesco's) proposal, pending discussion with the TC. The intent is to mirror the FIFA gestures in a simplified way.}
...
\info[inline]{For reference, the gesture is the same as the "Kick-in" gesture from the 2023 Visual Referee Challenge, but the opposite arm is raised with respect to back then.}
...
The referee makes an effort to sends the signal standing as close as possible to the T-junction joining the half-way line to the side line opposite to the GameController.
