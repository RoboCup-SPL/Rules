...
For Challenge Shield matches only, the referee will wear red gloves to increase visibility; however, teams are advised not to rely solely on this visual cue, as gloves may be omitted in future years.
No other objects or products covering the hands are allowed; any exception must be approved by the Technical Committee.
...
% Value for Challenge Shield isn't final but should be around 35-40. 
