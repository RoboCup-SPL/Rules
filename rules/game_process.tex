...
In the event that there has been a referee error or a pause in game and has been acknowledged by the head referee, and if a goal has not been scored by either team since the last initial kick-off play, the drop-ball rule shall apply.
