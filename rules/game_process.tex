...
\subsubsection{Indirect Kick - Champion Cup}
\label{sec:indirect_kick_champion}

A team may only score a goal via indirect kick from any start or restart into \texttt{playing}.

\begin{itemize}
  \item A robot may not score a goal from a direct kick, including via deflections.
  \item The ball must be deliberately played-at a second time by another robot before a goal may be scored.
  ...
  \item If an indirect free kick is kicked directly into the opponent's goal, the goal does not count and a goal kick is awarded.
...
\begin{description}
  ...
  \item[Example 2:] Player 2 (of the red team) kicks the ball at the goal, and it is deflected off the side of the foot of a blue-team's robot into the goal.
    This is \textit{not} an indirect kick, the goal does not count and a goal kick is awarded to the blue team.
  ...
  \item[Example 4:] Player 2 (of the red team), walks up to and dribbles the ball.
    ...
    The robot then scores. This is \textit{not} a successful indirect kick and a goal kick is awarded.
  ...
  \item[Example 6:] A penalty kick is awarded to the blue team. Player 2 (of the blue team) kick the ball. The red goalkeeper deflect the ball. Player 3 of blue team kick the ball in the red-team's goal.
  This is a successful indirect kick, and the goal counts.
\end{description}
