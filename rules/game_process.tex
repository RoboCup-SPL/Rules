...
In Champions Cup, the referee communicates which team is to take the free kick via a visual gesture made from \textcolor{red}{\textbf{[a specified position, or anywhere along the field border]}}.
...
This gesture is held for \textcolor{red}{\textbf{[no less than 2 seconds, and possibly more]}}.

In Challenge Shield, this visual signal is not performed and everything is communicated by the GameController.
