...
\subsubsection{Motion in Visual}
\label{sec:motion_in_visual}

Robots that begin to move during \texttt{visual} (\ie before the head referee does the visual signal).
The head referee will call ``Forbidden Motion in Visual\textless robot\textgreater''.
