...
Robots that begin moving their legs or locomote in any fashion before \texttt{ready} (\ie before the head referee does the visual signal) will be penalized \textit{in place} on the field for \qty{15}{\second} in \textit{playing}.
The head referee will call ``Forbidden Motion \textless robot\textgreater''.
