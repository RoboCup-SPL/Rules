...
Robots that begin moving their legs or locomote in any fashion before the specified state in the subsections
 will be penalized \textit{in place} on the field until the penalty is over for \qty{15}{\second} in the \textit{playing} state.
