...
setting it into the \emph{playing} state.%, which can be done either
%via the wireless or manually by an assistant referee. 
The penalty
...
\subsection{Field Player Pushing}
\label{sec:field_player_pushing}
